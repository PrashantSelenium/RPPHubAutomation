...
public class TestInitReferenceSmokeTest extends FunctionReference {
    private static final Logger LOGGER = Logger.getLogger(TestInitReferenceSmokeTest.class);
...
//            driver = new FirefoxDriver(new FirefoxBinary(), profile);
    	    ...
    	    caps.setCapability("build", "Smoke Test 4.17.1 Production");
